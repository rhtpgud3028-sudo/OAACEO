...
// v20.11 TTS-SYNC-VOLUME-BALANCED (2026-01-19)
// ============================================================
// 🔥 v20.11 핵심 변경:
// 1. TTS 볼륨 1.0 (Shotstack 최대값)
// 2. BGM 볼륨 0.15로 낮춤 (TTS 대비 강조)
// 3. ElevenLabs 노드 이름 정확히 지정 ('6. ElevenLabs TTS')
// 4. Convert Hook Audio 노드 참조
// 5. 동적 싱크 정상 작동!
// ============================================================
...
// 🆕 v20.11: 훅 TTS URL (Convert Hook Audio 노드에서!)
let hookTtsUrl = "";
try {
...
// 본문 TTS URL 및 alignment 데이터
let ttsAudioUrl = "";
let ttsAlignment = null;

try {
    // 🆕 v20.11: ElevenLabs 노드 이름 정확히!
...
// ==================== 9) Shotstack JSON (v20.11: BGM 볼륨 0.15!) ====================
const shotstackBody = {
    timeline: {
...
return [{
    json: {
        ...
        debug: {
            version: "20.11-TTS-SYNC-VOLUME-BALANCED",
