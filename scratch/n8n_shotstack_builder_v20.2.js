...
// v20.3 TTS-SYNC-FIX (2026-01-09)
// ============================================================
// 🔥 v20.3 수정사항:
// 1. TTS_OFFSET 4→1 (자막/이미지와 3초 싱크 조정)
// 2. 트랜지션 비활성화 유지 (자막 렌더링 문제 해결)
// 3. 인트로 타이틀 폴백 강화
// ============================================================
...
// v20.3: TTS 오프셋 조정 (4→1, 자막/이미지와 3초 싱크 맞춤)
const TTS_OFFSET = 1;
const audioClips = [];
