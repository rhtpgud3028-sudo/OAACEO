...
// v20.40 VIDEO-EXTENSION (2026-02-26)
// ============================================================
// 🎬 영상 120초 확장! TTS 완전 재생 보장!
...
// - 영상: 120초 (인트로 5초 + 이미지 115초)
// - GPT v6.17: 12문장, 각 55-65자, 총 660-780자
// - TTS 0초 시작 → 117초까지 완전 재생 → 120초 영상 안에 완료! ✅
// ============================================================

// ==================== 타임라인 설정 (위키 규칙 준수!) ====================
const INTRO_LEN = 5;          // 인트로 5초
const TARGET_TOTAL = 120;     // 🔴 120초! (TTS 완전 재생)
