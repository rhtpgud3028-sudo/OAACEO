...
// v20.16 PHASE2-DYNAMIC-BRANDING (2026-01-21)
// ============================================================
// 🔥 v20.16 핵심 변경:
// 1. Phase 2 동적 브랜딩 지원 (21채널)
// 2. Branding Router 노드에서 설정 가져오기
// 3. 자막 배경색 채널별 동적 적용
// 4. BGM 볼륨 0.15로 조정 (디테일 검증 결과)
...
const getSubtitleRules = () => {
    ...
    return {
        ...
        // ✅ v20.16.6: 자막 깨짐 해결 - width 추가 축소
        size: {
            width: 720,  // v20.16.6: 780→720 (자막 좌우 잘림 해결)
            height: 400
        },
        position: {
            offsetX: 0,
...
function formatSubtitle(text) {
    ...
    const MAX_CHARS_PER_LINE = 11;  // v20.16.6: 12→11 (더 축소)
    const lines = [];
