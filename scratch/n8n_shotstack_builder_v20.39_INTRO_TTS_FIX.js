...
// v20.39 INTRO-TTS-FIX (2026-02-26)
// ============================================================
// 🎤 인트로 TTS 추가! 0초부터 TTS 시작 (첫 문장 = 인트로!)
// 🎯 10문장 GPT v6.18 완전 대응 (28-32자 × 10 = 280-320자)
// ✅ 65초 = 인트로5s + 10슬라이드×6s (아웃트로 없음!)
// ✅ 21채널 5가지 베리에이션 (Transition/Effect/Filter/Style/BGM)
// ============================================================
// 📋 검증 근거:
// - 위키 영상 구조: "65초 숏츠: AI 인트로(5s) + 이미지(60s), 아웃트로 없음"
// - GPT v6.18: 10문장, 각 28-32자, 총 280-320자 (TTS 56-64초)
// - 위키 v20.31: 5가지 채널별 베리에이션
// - TTS 0초 시작: 첫 문장이 인트로 5초 동안 재생!
// ============================================================
...
const TARGET_SEGMENTS = 10;   // 🔴 10문장! (GPT v6.18)
...
if (ttsAudioUrl) {
    audioClips.push({
        ...
        start: 0,  // v20.39: 인트로부터 TTS 시작! (첫 문장 = hook_text)
        length: TARGET_TOTAL  // v20.39: TTS 전체 재생 (65초) - 0초부터 시작!
    });
}
