...
// v20.42 5060-NATURAL-SPEED (2026-02-26)
// ============================================================
// 🎬 영상 80초 최적화! 5060세대 자연스러운 속도 유지!
// 🎤 인트로 TTS 추가! 0초부터 TTS 시작!
// 🎯 GPT v6.17 완전 대응 (12문장 55-65자 = 660-780자)
// ✅ 120초 = 인트로5s + 12슬라이드×9.5s (아웃트로 없음!)
// ✅ 21채널 5가지 베리에이션 (Transition/Effect/Filter/Style/BGM)
// ============================================================
// 📋 검증 근거:
// - TTS: 525자 ÷ 4.5자/초 ≈ 117초
// - 영상: 80초 (인트로 5초 + 이미지 75초)
// - GPT v6.17: 12문장, 각 55-65자, 총 660-780자
// - TTS 0초 시작 → 78초까지 완전 재생 (speed 1.15 자연스럽게) ✅
// ============================================================

// ==================== 타임라인 설정 (위키 규칙 준수!) ====================
const INTRO_LEN = 5;          // 인트로 5초
const TARGET_TOTAL = 80;      // 🔴 80초! (65초 +15초)
...
if (ttsAudioUrl) {
    audioClips.push({
        ...
        start: 0,  // v20.40: 인트로부터 TTS 시작! (영상 120초로 확장)
        length: TARGET_TOTAL  // v20.40: TTS 전체 재생 (120초) - 0초부터 시작!
    });
}
