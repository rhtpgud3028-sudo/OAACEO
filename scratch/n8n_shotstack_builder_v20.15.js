...
// v20.15 VOLUME-BOOST-FIX (2026-01-20)
// ============================================================
// 🔥 v20.15 핵심 변경:
// 1. Hook TTS → Boost Hook Audio 노드에서 가져오기!
// 2. Body TTS → Boost Body Audio 노드에서 가져오기!
// 3. 이미지 병합 로직 개선 (모든 이미지 사용)
// 4. 이미지 10개로 변경 (비용 절감)
// ============================================================
...
return [{
    json: {
        ...
        debug: {
            version: "20.15-VOLUME-BOOST-FIX",
