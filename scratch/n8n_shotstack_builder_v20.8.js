...
// v20.8 65SEC + 12SLIDES (2026-01-14)
// ============================================================
// 🔥 v20.8 핵심 변경:
// 1. 65초 영상 (인트로 5초 + 슬라이드 12장 × 5초)
// 2. 12문장/12슬라이드 지원 (기존 8 → 12)
// 3. TARGET_SEGMENTS = 12로 변경
// 4. 멀티플랫폼 최적화 (YouTube Shorts + TikTok)
// ============================================================
...
const TARGET_TOTAL = 65;      // 🆕 v20.8: 65초! (기존 50초)
const BODY_START = 5;         // 본문 시작 시점 (인트로 끝)
const BODY_LEN = TARGET_TOTAL - INTRO_LEN - OUTRO_LEN;  // = 60초
const MIN_SEGMENTS = 8;       // 🆕 v20.8: 최소 8개
const MAX_SEGMENTS = 14;      // 🆕 v20.8: 최대 14개
const TARGET_SEGMENTS = 12;   // 🆕 v20.8: 목표 12개! (기존 8개)

// TTS 싱크 오프셋 (자막 & 슬라이드를 TTS보다 앞당김)
...
// 훅 TTS URL (Upload Hook Audio HTTP Request 노드에서!)
let hookTtsUrl = "";
try {
...
// 본문 TTS URL (Save Audio = Write Binary File 노드!)
let ttsAudioUrl = "";
try {
